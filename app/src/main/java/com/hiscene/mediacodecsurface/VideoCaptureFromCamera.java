...
public class VideoCaptureFromCamera implements
    ...
    protected void allocateAndStart() {
        ...
        cameraThreadHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                mInputSurfaceTexture.setOnFrameAvailableListener(VideoCaptureFromCamera.this);
            ...
            cameraThreadHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (mTextureView != null) {
                        if (mTextureView.getSurfaceTextureListener().equals(VideoCaptureFromCamera.this)) {
    ...
    private void doSetRendererView(TextureView temp) {
        ...
        mTextureView = temp;
        if (mTextureView != null) {
            mTextureView.setSurfaceTextureListener(VideoCaptureFromCamera.this);
        }
    }
    ...
    Surface mSurface;
    MediaCodecEncode encode;

    public void setEncode(MediaCodecEncode encode) {
        this.encode = encode;
    }
...
//            temp.setDefaultBufferSize(mCaptureWidth, mCaptureHeight);
            try {
                captureEglBase.createSurface(mSurface);
